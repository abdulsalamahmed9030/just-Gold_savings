  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        ...
        'gradient-gold': 'linear-gradient(135deg, hsl(43 74% 49%) 0%, hsl(35 75% 55%) 50%, hsl(43 74% 49%) 100%)',
        'gradient-midnight': 'linear-gradient(180deg, hsl(222 47% 6%) 0%, hsl(222 50% 12%) 100%)',
      },
    },
  },
